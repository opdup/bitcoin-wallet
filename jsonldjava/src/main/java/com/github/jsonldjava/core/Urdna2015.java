...
public class Urdna2015 {
    ...
    public Object normalize() {
        ...
        for (Map<String, Map<String, String>> quadMap : this.quads) {
            ...
            String q = quadMap.containsKey("name") && quadMap.get("name") != null
                    ? (quadMap.get("name"))
                    .get("value")
                    : null;
            RDFDataset.Quad quad = new RDFDataset.Quad(quadMap, q);
    ...
    private String hashFirstDegreeQuads(String id) {
        ...
        for (Object quad : quads) {
            ...
            String cq = copy.containsKey("name") && copy.get("name") != null
                    ? (copy.get("name"))
                    .get("value")
                    : null;
            RDFDataset.Quad copyQuad = new RDFDataset.Quad(copy, cq);
